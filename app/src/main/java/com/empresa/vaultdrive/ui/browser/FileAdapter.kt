            ...
            when {
                ...
                item.mimeType?.startsWith("image/") == true -> {
                    ...
                    if (!item.downloadUrl.isNullOrBlank()) {
                        ...
                        b.ivIcon.load(item.downloadUrl) { crossfade(true); transformations(RoundedCornersTransformation(12f)); placeholder(R.drawable.ic_image); error(R.drawable.ic_image) }
                    } else { b.ivIcon.setPadding(10,10,10,10); b.ivIcon.setImageResource(R.drawable.ic_image) }
                }
                else -> {
                    b.ivChevron.visibility = View.GONE; b.tvChildCount.visibility = View.GONE
                    b.ivIcon.setPadding(10,10,10,10)
